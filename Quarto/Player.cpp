...
Piece Player::PickPiece(std::istream& in, UnusedPieces& unusedPieces)
{
	std::string pieceName;
	in >> pieceName;
	Piece pickedPiece = unusedPieces.PickPiece(pieceName);
	return pickedPiece;
}

Board::Position Player::PlacedPiece(std::istream& in, Piece piece, Board& board)
{
